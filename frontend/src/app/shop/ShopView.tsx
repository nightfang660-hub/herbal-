  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#F8F5EE]">
      ...
      <div className="w-full overflow-hidden">
        ...
        <div 
          className="absolute inset-0 lg:left-auto lg:right-0 w-full lg:w-[50%] xl:w-[55%] z-0"
        >
           <Image src="/assets/shopheros.png" alt="Shop Hero" fill priority className="object-cover object-[60%_center] lg:object-[90%_center]" sizes="(max-width: 1024px) 100vw, 50vw" />
        ...
        <div className="flex-1 max-w-[1400px] w-full flex flex-col justify-end pb-10 pt-20 lg:justify-center lg:py-20 mx-auto px-6 sm:px-8 xl:px-12 relative z-10">
          ...
          >
            ...
            <div className="hidden lg:flex items-center gap-4">
              <span className="text-[#9F7E28] font-bold text-[11px] lg:text-[13px] tracking-widest uppercase">
                <span className="hidden lg:inline">Shop Our Collection</span>
              </span>
              <div className="hidden lg:block w-12 h-[2px] bg-[#9F7E28]"></div>
            </div>
            ...
            <h1 className="text-[34px] sm:text-[46px] md:text-[52px] lg:text-[56px] xl:text-[64px] font-bold text-white lg:text-[#0F3D2E] leading-[1.05] tracking-tight drop-shadow-md lg:drop-shadow-none" style={{ fontFamily: 'Playfair Display, serif' }}>
              ...
              <span className="text-[#9F7E28]">Herbal Blend.</span>
            </h1>
            ...
            <div className="pt-3 lg:pt-0 pb-4 lg:pb-0">
              <button className="flex items-center gap-2 bg-[#0F3D2E] text-white px-5 lg:px-8 py-2.5 lg:py-3.5 rounded-[6px] lg:rounded-[8px] hover:bg-[#0F3D2E] transition-colors shadow-md lg:shadow-lg text-[13px] lg:text-[15px] font-bold justify-center transition-all hover:shadow-lg lg:hover:shadow-xl hover:-translate-y-0.5 w-max" style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
                ...
                <ArrowRight className="w-3.5 h-3.5 lg:w-4 lg:h-4 text-white lg:text-[#9F7E28]" />
              </button>
            </div>
          ...
          <div className="w-full lg:w-3/4 order-3 lg:order-2 flex flex-col gap-6">
            ...
            {loading ? (
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="flex flex-col bg-white rounded-2xl md:rounded-[20px] border border-[#e8e5de] p-3 md:p-5 shadow-sm animate-pulse">
                    <div className="w-full h-[160px] md:h-[280px] bg-gray-200/60 rounded-t-xl mb-4"></div>
                    <div className="flex flex-col flex-1">
                      ...
                      <div className="h-8 md:h-10 bg-gray-200/60 rounded w-full mt-auto"></div>
                    </div>
                  </div>
                ))}
              </div>
                ...
                {filteredProducts.map(product => (
                  ...
                  <div className="relative w-full h-[160px] md:h-[280px] mb-4 bg-white rounded-t-xl pt-1 md:pt-2 px-1 overflow-hidden group/image">
                    ...
                    <div className="w-full h-full flex transition-transform duration-700 ease-out group-hover:-translate-x-full">
                      <div className="w-full h-full shrink-0 flex items-center justify-center relative">
                        <Image 
                          src={product.img} 
                          alt={product.name} 
                          fill
                          sizes="(max-width: 768px) 160px, 280px"
                          className="object-contain mix-blend-multiply scale-[1.15] md:scale-110 transition-transform duration-700" 
                        />
                      </div>
                      <div className="w-full h-full shrink-0 flex items-center justify-center relative">
                        <Image 
                  ...
                  <div className="flex flex-col flex-1">
                    ...
                    <h3 className="font-extrabold text-[#0F3D2E] text-[14px] md:text-[18px] leading-tight mb-1 md:mb-2 transition-colors duration-300 line-clamp-2 md:line-clamp-none" style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
                      {product.name}
                    </h3>
          ...
          <div className="hidden lg:flex w-1/4 flex-col gap-10 sticky top-28">
            ...
            <div>
              ...
              <div className="relative flex items-center bg-white border border-[#e8e5de] rounded-full pl-4 pr-1.5 py-1 w-[85%] shadow-sm focus-within:border-[#D4AF37] focus-within:ring-1 focus-within:ring-[#D4AF37] transition-all">
                ...
                />
                <button aria-label="Search" className="bg-[#D4AF37] text-white p-2.5 rounded-full hover:bg-[#d4a844] transition-colors flex items-center justify-center cursor-pointer shrink-0">
              ...
              <div className="flex flex-col gap-3">
                 {BENEFITS.map(ben => (
                   <label key={ben} className="flex items-center gap-3 cursor-pointer group">
                     ...
                     <span className={`text-[14px] transition-colors ${selectedBenefit === ben ? 'text-[#0F3D2E] font-medium' : 'text-[#4a5d53] group-hover:text-[#0F3D2E]'}`} style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
                       {ben}
                     </span>
                   </label>
                 ))}
              ...
              <div className="flex flex-col gap-3">
                 {INGREDIENTS.map(ing => (
                   <label key={ing} className="flex items-center gap-3 cursor-pointer group">
                     ...
                     <span className={`text-[14px] transition-colors ${selectedIngredient === ing ? 'text-[#0F3D2E] font-medium' : 'text-[#4a5d53] group-hover:text-[#0F3D2E]'}`} style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
                       {ing}
                     </span>
                   </label>
                 ))}
              ...
              <div className="flex flex-col gap-3">
                 {CATEGORIES.map(cat => (
                   <label key={cat} className="flex items-center gap-3 cursor-pointer group">
                     ...
                     <span className={`text-[14px] transition-colors ${selectedCategory === cat ? 'text-[#0F3D2E] font-medium' : 'text-[#4a5d53] group-hover:text-[#0F3D2E]'}`} style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
                       {cat}
                     </span>
                   </label>
                 ))}
              ...
              <div className="flex flex-col gap-3">
                 {RATINGS.map(rate => (
                   <label key={rate} className="flex items-center gap-3 cursor-pointer group">
                     ...
                     <span className={`text-[14px] transition-colors flex items-center gap-1 ${selectedRating === rate ? 'text-[#0F3D2E] font-medium' : 'text-[#4a5d53] group-hover:text-[#0F3D2E]'}`} style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6 pb-28 space-y-8">
                ...
                <div>
                  ...
                  <div className="relative flex items-center bg-white border border-[#e8e5de] rounded-full pl-4 pr-1.5 py-1 w-full shadow-sm focus-within:border-[#D4AF37] focus-within:ring-1 focus-within:ring-[#D4AF37] transition-all">
                    ...
                    />
                    <button aria-label="Search" className="bg-[#D4AF37] text-white p-2 rounded-full hover:bg-[#d4a844] transition-colors flex items-center justify-center shrink-0">
                      <Search className="h-4 w-4 text-slate-800" />
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="px-1 relative pt-8">
                    ...
                    <input 
                      type="range" 
                      aria-label="Filter by Price Mobile"
                      min="200" 
                      max="1020" 
                      value={priceValue}
                      onChange={(e) => setPriceValue(Number(e.target.value))}
